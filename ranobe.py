    ...
    while True:
        ...
        for item in series:
            ...
            rows.append({
                ...
                "romaji_orig":
                    item.get("romaji_orig"),

                "lang":
                    item.get("lang"),

                "num_books":
                    item.get("c_num_books")
            })
